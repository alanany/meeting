...
mixin AlertsMixin<T extends StatelessElement> {
  ...
  Future<void> showSuccessDialog(
      BuildContext context, String successMessage, Duration duration) async {
  ...
  Future<void> showInSnackBar() async {
    _scaffoldKey.currentState.showSnackBar(new SnackBar
      ...
      height: 50,
      child: Center(
        child: Text('يرجى التاكد من البريد الالكترونى والرقم السرى ',
  ...
  void showErrorDialog(
      BuildContext context, String errorMessage, Duration duration) {
    showDialog(
      context: context,
      barrierDismissible: true,
      builder: (BuildContext context) => Platform.isIOS
