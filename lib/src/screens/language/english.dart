        ...
        Container(
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: AssetImage(
                'assets/imgs/language_background.png',
              ),
            ),
          ),
        ),
                      ...
                      Row(
                        children: <Widget>[
                          Container(
                            decoration: BoxDecoration(
                              border: Border(
                                bottom: BorderSide(color:Color.fromRGBO(191, 145, 67, 1),width: 2.0),
                              ),
                            ),
                            child:Text(
                              'English',style: TextStyle(fontSize: 22,color: Colors.white,
                          ...
                          Container(
                            child: InkWell(
                                child:Text(
                                  'العربيه',style: TextStyle(fontSize: 22,color: Colors.grey,
                                    fontWeight:FontWeight.bold,
                                    fontFamily: 'Almarai-Bold'
                                ),
                                ) ,
